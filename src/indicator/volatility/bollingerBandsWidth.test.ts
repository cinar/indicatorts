...
describe('Bollinger Bands Width (BBW)', () => {
  ...
  it('should be able to compute with a config', () => {
    ...
    console.log(roundDigitsAll(2, actual.bandWidth));
    console.log(roundDigitsAll(2, actual.bandWidthEma));
    deepStrictEqual(roundDigitsAll(2, actual.bandWidth), expectedBandWidth);
    deepStrictEqual(
      roundDigitsAll(2, actual.bandWidthEma),
      expectedBandWidthEma
    );
  });
